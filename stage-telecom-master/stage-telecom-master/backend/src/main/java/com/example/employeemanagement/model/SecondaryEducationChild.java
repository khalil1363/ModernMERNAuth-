...
@Entity
@Table(name = "secondary_education_children")
public class SecondaryEducationChild {
    ...
    @JsonBackReference("employee-secondaryChildren")
    private Employee employee;
    
    // Constructors
    public SecondaryEducationChild() {}
    
    public SecondaryEducationChild(String childFullName, LocalDate childBirthDate, String academicYear) {
