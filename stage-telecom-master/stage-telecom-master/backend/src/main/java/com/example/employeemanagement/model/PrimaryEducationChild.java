...
@Entity
@Table(name = "primary_education_children")
public class PrimaryEducationChild {
    ...
    @JsonBackReference("employee-primaryChildren")
    private Employee employee;
    
    // Constructors
    public PrimaryEducationChild() {}
    
    public PrimaryEducationChild(String childFullName, LocalDate childBirthDate, String academicYear) {
